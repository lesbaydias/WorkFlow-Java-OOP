...
public class Sedan implements CarsInterface {
    ...
    public Sedan(String carName, String company, String address, TypeOfCar typeOfCar, Seller username, int price, int year, double engineCapacity, String color, int mileAge) throws WrongMessageException {
