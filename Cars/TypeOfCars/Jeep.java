...
public class Jeep implements CarsInterface {
    ...
    public Jeep(String carName, String company, String address, TypeOfCar typeOfCar, Seller username, int price, int year, double engineCapacity, String color, int mileAge) throws WrongMessageException {
